...
def analyze():
    ...
    if OPENAI_API_KEY:
        try:
            prompt = f"""
Analyze this GitHub profile and format the response in clean **Markdown** with proper headings and bullet points.
...
1. **Strengths**
2. **Weaknesses**
3. **Main Language Proficiency**
4. **Overall Impression**
"""
            response = client.chat.completions.create(
                model="gpt-4o-mini",
                messages=[
                    {"role": "system", "content": "You are an AI that analyzes GitHub profiles and outputs structured Markdown."},
